...
void	Timer_config(void)//初始化 定时器`
{
	...
	TIM_InitStructure.TIM_ClkSource = TIM_16BitAutoReload;	// 16位自动重装  TIM_16BitAutoReload,TIM_16Bit,TIM_8BitAutoReload,TIM_16BitAutoReloadNoMask
	...
	TIM_InitStructure.TIM_Value     = 65536UL - (MAIN_Fosc / 100);		   //5MS 
...
{ 
	...
	TaskUartFlag=1;
//	TH1=(u8)(65536UL - (MAIN_Fosc / 500))/256;
//	TL1=(u8)(65536UL - (MAIN_Fosc / 500))%256;
//	COM1.RX_Cnt=0;
	TR1 = 0;
//	T1_1MS1++;
//	T1_10MS2++;
