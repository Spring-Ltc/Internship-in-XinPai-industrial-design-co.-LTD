...
//		 
//		do{
//			  if(   (SensorWater(1)==NoExist)
// 		        &&(SensorWater(2)==NoExist)
// 	          &&(SensorWater(3)==NoExist)
// 	          &&(SensorWater(4)==NoExist)
// 	          &&(SensorWater(5)==NoExist)	)
//			    {
...
//					 Second1=0;
//          }
// 	      if (TimerOut>=10)	 break;	
//		 
//		  }while(TimerOut<=4 || MachineStatus);